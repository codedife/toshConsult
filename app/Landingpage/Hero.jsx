...
const Hero = () => {
  return (
          <section className='bg-pink-100 h-auto w-full flex items-center justify-center flex-col space-y-10 mt-14'>
            ...
            <div className='flex flex-row justify-between w-[70vw] mt-16'>
              ...
              <Image
                src={img1}
                alt='re'
                className='h-[35vh] w-auto hero-left hero-float'
              />

              <div className='flex flex-col items-center w-[35vw] h-auto space-y-5 hero-content'>
              ...
              <Image
                src={img2}
                alt='re'
                className='h-[35vh] w-auto hero-right hero-float'
              />

            </div>

            <div className='flex flex-row justify-between w-[60vw] hero-bottom'>
              ...
              <button className='bg-black h-[10vh] w-[10vw] p-2 rounded-4xl text-[10px] cursor-pointer hover:bg-white hover:text-black mt-2 hero-button'>
                Get Started
              </button>

              <Image
                src={img4}
                className='h-[35vh] w-auto mb-16'
              />
